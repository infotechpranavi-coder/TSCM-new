...
export default function TSCMServicesBangalore() {
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
         <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            >
               Professional Bug Sweeping & Counter-Surveillance. Helping businesses and individuals in {city} detect and eliminate surveillance threats.
            </motion.p>
         </div>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
               <div className="flex-1">
                  ...
                  <p className="text-slate-600 leading-relaxed text-lg mb-6">
                     Technical Surveillance Countermeasures (TSCM) is a specialized security process used to detect, identify, and remove unauthorized surveillance devices. Our TSCM experts in {city} use advanced bug sweeping technology to conduct thorough inspections.
                  </p>
         ...
         <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
               {[
                  { icon: <Building2 />, title: "Corporate TSCM", desc: "Corporate espionage is a growing concern. Our corporate services detect and remove these threats, protecting your organization." },
                  { icon: <Home />, title: "Residential TSCM", desc: "Your home should be a safe space. Our residential TSCM services provide a thorough inspection to ensure your privacy." },
                  { icon: <Hotel />, title: "Hotel & Airbnb", desc: "Hidden cameras are a significant concern. Our bug sweeping services scan and detect any surveillance equipment." },
                  { icon: <Car />, title: "Vehicle GPS Tracking", desc: "If you believe your vehicle is being tracked, we will scan for hidden tracking devices and eliminate them." },
                  { icon: <Network />, title: "Cyber TSCM", desc: "Hackers can gain unauthorized access. We specialize in detecting and removing spyware, keyloggers, and cyber vulnerabilities." }
               ].map((srv, i) => (
                  <motion.div 
                     key={i}
            ...
            >
               ...
               <div className="space-y-6">
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Experienced Specialists</h4>
                     <p className="text-slate-600">Our team consists of trained professionals skilled in electronic counter-surveillance.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Advanced Detection Technology</h4>
                     <p className="text-slate-600">We use RF spectrum analyzers, non-linear junction detectors, and thermal imaging scanners.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Confidential & Discreet</h4>
                     <p className="text-slate-600">All investigations are conducted with the utmost professionalism and confidentiality.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Comprehensive Solutions</h4>
                     <p className="text-slate-600">Our services cover corporate offices, homes, hotels, vehicles, and digital systems.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Affordable & Reliable</h4>
                     <p className="text-slate-600">We provide top-tier TSCM services in {city} at competitive rates.</p>
                  </div>
               </div>
            </motion.div>
