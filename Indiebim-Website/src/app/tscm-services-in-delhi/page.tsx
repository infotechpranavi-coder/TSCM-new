...
export default function TSCMServicesDelhi() {
  const city = "Delhi";
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
         <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            >
               Expert Bug Sweeping & Counter-Surveillance. Securing your sensitive information from hidden cameras, audio bugs, GPS trackers, and spyware in {city}.
            </motion.p>
         </div>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
               <div className="flex-1">
                  ...
                  <p className="text-slate-600 leading-relaxed text-lg mb-6">
                     Technical Surveillance Countermeasures (TSCM) is an advanced security service designed to detect, identify, and neutralize unauthorized surveillance devices. Our TSCM specialists in {city} use state-of-the-art technology to conduct thorough bug sweeps.
                  </p>
               ...
               <div className="w-full md:w-1/3 flex justify-center">
                  <div className="w-48 h-48 bg-white rounded-full border border-cyan-200 flex items-center justify-center relative shadow-[0_0_30px_rgba(6,182,212,0.1)]">
                     <ShieldCheck className="w-20 h-20 text-cyan-600" />
                  </div>
               </div>
            </div>
         </div>
         ...
         <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
               {[
                  { icon: <Building2 />, title: "Corporate TSCM", desc: `Business espionage is a major concern. Our corporate services in ${city} help secure boardrooms from unauthorized surveillance threats.` },
                  { icon: <Home />, title: "Residential TSCM", desc: "Your home should be a safe space. Our residential services provide a meticulous inspection to ensure your privacy remains protected." },
                  { icon: <Hotel />, title: "Hotel & Airbnb", desc: "Travelers are increasingly at risk. Our bug sweeping services scan for unauthorized surveillance devices for your security." },
                  { icon: <Car />, title: "Vehicle GPS Tracking", desc: "If you suspect tracking movements, our GPS tracking detection service thoroughly inspects and removes trackers." },
                  { icon: <Network />, title: "Cyber TSCM", desc: "Identify and eliminate cyber vulnerabilities, securing your devices and networks against digital espionage." }
               ].map((srv, i) => (
                  <motion.div 
                     key={i}
            ...
            >
               ...
               <div className="space-y-6">
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Highly Trained Experts</h4>
                     <p className="text-slate-600">Our team comprises skilled professionals experienced in counter-surveillance and electronic security.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                  ...
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Confidential Investigations</h4>
                     <p className="text-slate-600">We conduct all bug sweeps and surveillance detection services with complete discretion.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Customized Security Solutions</h4>
                     <p className="text-slate-600">Catering to corporate offices, homes, hotels, vehicles, and digital systems.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Affordable & Reliable</h4>
                     <p className="text-slate-600">We offer top-quality TSCM services in {city} at competitive prices.</p>
                  </div>
               </div>
            </motion.div>
