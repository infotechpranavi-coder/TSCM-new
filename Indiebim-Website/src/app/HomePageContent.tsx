  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative isolate overflow-hidden bg-[linear-gradient(180deg,#f8fafc_0%,#ffffff_42%,#f0f9ff_100%)]">
        ...
        <div className="pointer-events-none absolute inset-0 opacity-[0.35] bg-[linear-gradient(rgba(148,163,184,0.12)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.12)_1px,transparent_1px)] bg-size-[64px_64px]" />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 pb-20 pt-24 sm:px-6 sm:pb-24 sm:pt-28 lg:px-8 lg:pb-28 lg:pt-32">
          <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
              ...
              >
                ...
                <AnimatePresence mode="wait">
                  <motion.span
                    ...
                    className="inline-block text-transparent bg-clip-text bg-linear-to-r from-cyan-600 to-sky-700"
                  >
            ...
            >
              <div className="absolute -inset-3 rounded-4xl bg-linear-to-br from-cyan-200/50 via-transparent to-indigo-200/40 blur-2xl" />
              <div className="relative overflow-hidden rounded-[1.75rem] border border-slate-200/90 bg-white shadow-[0_28px_80px_-20px_rgba(15,23,42,0.2)]">
                <div className="relative aspect-4/5 max-h-[min(72vh,520px)] w-full sm:aspect-5/6">
                  ...
                  <div className="pointer-events-none absolute inset-0 bg-linear-to-t from-slate-900/75 via-slate-900/10 to-transparent" />
      ...
      <section className="relative z-10 overflow-hidden border-y border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f5fbff_48%,#eef7fb_100%)] py-24">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-24 top-10 h-56 w-56 rounded-full bg-cyan-200/45 blur-3xl" />
          <div className="absolute -right-16 top-1/3 h-64 w-64 rounded-full bg-sky-200/35 blur-3xl" />
          <div className="absolute inset-0 opacity-40 bg-[linear-gradient(rgba(15,23,42,0.04)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.04)_1px,transparent_1px)] bg-size-[72px_72px]" />
        </div>
          ...
          >
            {[
              ...
              <motion.article
                key={i}
                variants={fadeIn}
                className="group relative overflow-hidden rounded-4xl border border-white/70 bg-white/92 shadow-[0_20px_55px_rgba(15,23,42,0.08)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_28px_75px_rgba(14,116,144,0.16)]"
              >
                <div className={`absolute inset-x-0 top-0 h-1.5 bg-linear-to-r ${feature.tone}`} />
                ...
                <div className="pointer-events-none absolute inset-0 rounded-4xl ring-1 ring-transparent transition-all duration-300 group-hover:ring-cyan-200/70" />
              </motion.article>
            ))}
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h3 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
                Are You Being <span className="text-transparent bg-clip-text bg-linear-to-r from-rose-500 to-orange-500">Secretly Watched?</span>
              </h3>
            ...
            >
               <div className="relative w-full max-w-sm overflow-hidden rounded-3xl shadow-2xl border border-slate-200">
                 <div className="absolute inset-0 bg-linear-to-br from-cyan-500/10 to-blue-500/10 z-10 pointer-events-none rounded-3xl"></div>
                 <video
      ...
      <section className="border-y border-slate-100 bg-white py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative mt-12">
            <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-10 bg-linear-to-r from-white via-white/80 to-transparent" />
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-10 bg-linear-to-l from-white via-white/80 to-transparent" />
            <div
      ...
      <section className="relative overflow-hidden border-y border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fafc_46%,#ecfeff_100%)] py-24">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -left-12 top-16 h-48 w-48 rounded-full bg-cyan-200/40 blur-3xl" />
          <div className="absolute -right-16 bottom-12 h-56 w-56 rounded-full bg-sky-200/30 blur-3xl" />
        </div>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
            {galleryPreviewImages.map((image, index) => (
              <motion.article
                ...
                className="group overflow-hidden rounded-3xl border border-white/80 bg-white shadow-[0_16px_40px_rgba(15,23,42,0.08)]"
              >
