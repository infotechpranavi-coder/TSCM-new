...
export default function BugSweepingServicesBangalore() {
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
         <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            >
               Protect Your Privacy with Experts. Detecting and eliminating hidden surveillance threats to protect your confidential information in {city}.
            </motion.p>
         </div>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
               <div className="flex-1">
                  ...
                  <p className="text-slate-600 leading-relaxed text-lg mb-6">
                     Bug sweeping, also known as Technical Surveillance Countermeasures (TSCM), is the process of detecting and removing unauthorized surveillance devices.
                  </p>
                  <ul className="grid sm:grid-cols-2 gap-4">
                     {[
                        ...
                        "Planted devices in targeted zones"
                     ].map((item, i) => (
         ...
         <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
               {[
                  { icon: <Building2 />, title: "Corporate Bug Sweeping", desc: "Business espionage is a serious concern. Our corporate bug sweep services protect boardrooms, offices, and IT infrastructure from surveillance threats." },
                  { icon: <Home />, title: "Residential Bug Sweeping", desc: "Concerned about hidden cameras or listening devices in your home? Our home bug sweep service ensures your privacy in living spaces and private areas." },
                  { icon: <Hotel />, title: "Hotel & Airbnb", desc: "Hidden cameras and recording devices are becoming a growing concern. Our bug detection service scans accommodations to identify privacy threats." },
                  { icon: <Car />, title: "Vehicle GPS Tracking", desc: "Suspect that your car is being tracked? Our experts use advanced GPS detection technology to locate and remove trackers." },
                  { icon: <Network />, title: "Cyber TSCM", desc: "Cyber threats can compromise personal and business data. Our cyber TSCM service identifies security vulnerabilities in computers and networks." }
               ].map((srv, i) => (
                  <motion.div 
                     key={i}
            ...
            >
               ...
               <div className="space-y-6">
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Experienced TSCM Experts</h4>
                     <p className="text-slate-600">Our specialists have years of experience in counter-surveillance and electronic bug detection.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">State-of-the-Art Technology</h4>
                     <p className="text-slate-600">We use advanced RF spectrum analyzers, thermal imaging, and non-linear junction detectors.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Discreet & Confidential Service</h4>
                     <p className="text-slate-600">Your privacy is our top priority. We conduct all investigations with complete confidentiality.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Affordable & Reliable</h4>
                     <p className="text-slate-600">Our services are competitively priced, ensuring top-quality security solutions without exceeding your budget.</p>
                  </div>
               </div>
            </motion.div>
