...
export default function BugSweepingServicesMumbai() {
  const city = "Mumbai";
    ...
    <div className="flex flex-col min-h-screen bg-slate-50 pt-32 pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
         <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            >
               Protect Your Privacy from Hidden Surveillance. In today’s digital world, unauthorized surveillance is a growing concern for businesses and individuals alike.
            </motion.p>
         </div>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
               <div className="flex-1">
                  ...
                  <p className="text-slate-600 leading-relaxed text-lg mb-6">
                     Bug sweeping, also known as Technical Surveillance Countermeasures (TSCM), is a security process that involves identifying and removing electronic surveillance devices.
                  </p>
                  <ul className="grid sm:grid-cols-2 gap-4">
                     {[
                        ...
                        "Spyware and digital surveillance threats"
                     ].map((item, i) => (
         ...
         <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
               {[
                  { icon: <Building2 />, title: "Corporate Bug Sweeping", desc: "Corporate espionage is a real threat. Our corporate bug sweep services protect sensitive discussions, trade secrets, and business strategies." },
                  { icon: <Home />, title: "Residential Bug Sweeping", desc: "Hidden cameras and listening devices can put security at risk. Our home bug sweep service ensures your residence remains safe." },
                  { icon: <Hotel />, title: "Hotel & Airbnb", desc: "Travelers worry about hidden cameras in rooms. Our experts thoroughly inspect temporary lodgings to ensure privacy." },
                  { icon: <Car />, title: "Vehicle GPS Tracking", desc: "If you suspect someone is tracking your movements, our service will scan your car for tracking devices and remove them." },
                  { icon: <Network />, title: "Digital Bug Sweeping", desc: "Cyber threats can compromise your data. Our digital sweeping services detect and eliminate threats from computers and networks." }
               ].map((srv, i) => (
                  <motion.div 
                     key={i}
            ...
            >
               ...
               <div className="space-y-6">
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Highly Skilled TSCM Experts</h4>
                     <p className="text-slate-600">Our trained professionals specialize in counter-surveillance and electronic bug detection.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                  ...
                  <div className="border-l-2 border-cyan-500 pl-6">
                     ...
                     <p className="text-slate-600">We handle every case with utmost discretion and professionalism to protect your privacy.</p>
                  </div>
                  <div className="border-l-2 border-cyan-500 pl-6">
                     <h4 className="text-slate-900 font-bold text-lg mb-2">Comprehensive Solutions</h4>
                     <p className="text-slate-600">Our services cover corporate offices, residences, vehicles, and digital systems.</p>
                  </div>
               </div>
            </motion.div>
